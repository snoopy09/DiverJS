...
var util = require("util"),
	logger = require("./node-logger-63db153c12b2350dad8bf273b0fb537893a717c3/index.js"),
	assert = require("assert-plus"),
	fs = require("fs");
// S$.registerAsyncTasks(fs, "fs", ["", "mkdir"]);
...
function canWrite(owner, inGroup, mode) {
	return (owner && (mode & 200)) || // User is owner and owner can write.
		(inGroup && (mode & 20)) || // User is in group and group can write.
		(mode & 2); // Anyone can write.
